...
public class FlakyTestsProcessor {
    ...
    public static ArrayList<FlakyTestsInfo>  calculate(File root, Vector<PackageBean> packages, Vector<PackageBean> testPackages, Project proj){
        try {
            ...
            ArrayList<FlakyTestsInfo> flakyTests = new ArrayList<>();
            ...
            for (ClassBean productionClass : classes) {
                ...
                LOGGER.info("STARTING FIRST RUN TESTS");
                ...
                LOGGER.info("FIRST RUN TESTS END");
                for(int i=0; i<9; i++){
                ...
                flakyTests.add(info);
                LOGGER.info(passedTests.toString());
            }
            return flakyTests;
